...
const Biography = () => {
  return (
    <div id="biography" className="flex flex-col justify-start items-center w-full relative overflow-hidden gap-[100px] p-[100px] rounded-tl-[80px] rounded-tr-[80px] bg-white">
      <div className="flex-grow-0 flex-shrink-0 w-full h-full">
        <div className="flex justify-center items-center w-full left-[100px] top-[100px] gap-10">
          <div className="relative w-[150px] h-[150px] rounded-full overflow-hidden border-4 border-primary flex items-center justify-center bg-secondary">
          ...
          <div className="flex justify-between items-center flex-grow">
            <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-2.5">
              <p className="flex-grow-0 flex-shrink-0 text-[40px] font-bold text-left uppercase text-primary">
                BIOGRAPHY
              </p>
            ...
            <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 w-[321px] gap-8 py-1">
